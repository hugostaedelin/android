...
/**
 * Created by Pascal Jean-Louis on 25/01/2017.
 */
...
public class TCPClient {
    ...
    public void sendMessage(String message){
        Log.d("sendMessage", "envoi en cours...");
        if (out != null && !out.checkError()) {
            out.print(message);
            out.flush();
            Log.d("sendMessage", "messageEnvoye");
        }
        else {
            Log.d("sendMessage", "Echec de l'envoi du message");
        }
    }
